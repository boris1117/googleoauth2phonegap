...
ChildBrowser.PAGE_LOADED = 2;

ChildBrowser.prototype.onPageLoaded=function(html) {
...
ChildBrowser.prototype._onEvent = function(data) {
    ...
    if (data.type == ChildBrowser.PAGE_LOADED && typeof window.plugins.childBrowser.onPageLoaded === "function") {
